            ...
            if (history.pushState) {
                ...
                $('#content').parent().fadeOut(200, function(el) {
                    ...
                    if (slugLink == 'contact') {
                        ...
                        if (isEmpty == '') {
                            $(el).append('<div style="display: none;" id="content">'+datas.content['content']+'</div><div id="contactForm">'+datas.content['contactForm']+'</div>').fadeIn(speed);
                        } else {
                            $(el).append('<div id="content">'+datas.content['content']+'</div><div id="contactForm">'+datas.content['contactForm']+'</div>').fadeIn(speed);
                        }
                    } else if (slugLink == 'gallery') {
                        var isEmpty = $(datas.content['content']).text();
                        if (isEmpty == '') {
                            $(el).append('<div style="display: none;" id="content">'+datas.content['content']+'</div><div id="galleriesWrapper">'+datas.content['galleries']+'</div>').fadeIn(speed);
                        } else {
                            $(el).append('<div id="content">'+datas.content['content']+'</div><div id="galleriesWrapper">'+datas.content['galleries']+'</div>').fadeIn(speed);
                        }
                        if ($isMobile) {
                        ...
                        $(el).append('<div id="content">'+datas.content+'</div>').fadeIn(speed);
                    }
                    if (slugLink == 'home') {
